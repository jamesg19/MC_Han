...
import static hanoi_2.pkg0.MainFrame.labelContador;
...
public class Dibujo extends JPanel implements ActionListener {
    ...
    private void inicializarComponentesDeAnimacion() {
        ...
        topes[3] = 0;
        ficha = 1;
        // formula para hallar la contidad de movimientos minimos o necesarios 2^n -1
    ...
    public void algoritmoHanoi(int n, int origen, int temporal, int destino) {
        ...
        //////////
        labelContador.setText("Movimiento minimo: "+nm);
